...
- (void)layoutPageSubViews{
    ...
    self.okBtn.frame=CGRectMake(0, 0, 64, 40);
    self.okBtn.centerY=self.titleV.centerY;
    self.okBtn.right=self.titleV.right;
    
    self.cancelBtn.frame=CGRectMake(0, 0, 64, 40);
    self.cancelBtn.centerY=self.titleV.centerY;
